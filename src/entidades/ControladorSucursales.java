...
//    public SucursalDepartamental obtenerSucursalDepartamental(String ciudad) {
//        for (SucursalDepartamental sd : sucursalesDepartamentales) {
//            if (sd.getCiudad().equals(ciudad)) {
//                return sd;
//            }
...
//    }
//
//    public ArrayList<SucursalProvincial> obtenerSucursalesProvinciales(String codigoDepartamental) {
//        for (SucursalDepartamental sd : sucursalesDepartamentales) {
//            if (sd.getCodigo().equals(codigoDepartamental)) {
//                return sd.getSucursales();
//            }
//        }
