 ...
 * @author Sistemas
 */
public class IFrmListaClientes extends javax.swing.JInternalFrame {

    /**
     * Creates new form IFrmListaMonedas
     */
    public IFrmListaClientes() {
        initComponents();
    ...
    private void initComponents() {
        ...
        jPanel1.setBorder(javax.swing.BorderFactory.createTitledBorder(javax.swing.BorderFactory.createEtchedBorder(), "Lista Clientes", javax.swing.border.TitledBorder.CENTER, javax.swing.border.TitledBorder.DEFAULT_POSITION, new java.awt.Font("Segoe UI", 1, 18), new java.awt.Color(0, 0, 0))); // NOI18N
        ...
        tblEmpleados.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String [] {
                "Código", "Nombre", "Apellidos", "Ciudad", "Dirección", "Email", "Dni"
            }
        ));
        ...
        jPanel2.setBorder(javax.swing.BorderFactory.createTitledBorder(javax.swing.BorderFactory.createLineBorder(new java.awt.Color(0, 0, 0)), "Lista Clientes", javax.swing.border.TitledBorder.DEFAULT_JUSTIFICATION, javax.swing.border.TitledBorder.DEFAULT_POSITION, new java.awt.Font("Tahoma", 0, 15), new java.awt.Color(0, 0, 153))); // NOI18N
    ...
    private void formInternalFrameOpened(javax.swing.event.InternalFrameEvent evt) {//GEN-FIRST:event_formInternalFrameOpened
        lista = BLCliente.listarClientes();
        llenarTabla();
    ...
    private void llenarTabla() {
        ...
        while (iterador.hasNext()) {
            ...
            fila[2] = empl.getApellidoPaterno() + " "+empl.getApellidoMaterno();
            fila[3] = empl.getCiudad();
            fila[4] = empl.getDireccion();
            fila[5] = empl.getEmail();
            fila[6] = empl.getDni();
            modelo.addRow(fila);
        }
    ...
    private String columnas[] = {"Código", "Nombre", "Apellidos", "Ciudad", "Dirección", "Email","Dni"};
    private Object fila[] = new Object[columnas.length];
    private Iterator<Cliente> iterador;
 
    private Cliente empl;
}
