...
public static Movimiento obtenerMovimiento(String Codigo) {
        ...
        try {
            ...
            obj.setFechaCreacionCorta(new GregorianCalendar(Integer.parseInt(date[0]), Integer.parseInt(date[1]) - 1, Integer.parseInt(date[2])));  
            ...
            obj.setTipoMovimiento(String.parseString(rs.getString(7)));
        }
    ...
    public static ArrayList<Movimiento> listarMovimientos() {
        ...
        try {
            ...
            //  public Movimiento(int numero, GregorianCalendar fecha, float importe, String referencia, String cuenCodigo, String empCodigo, String tipoMovimiento)
                movimientos.add(new Movimiento(rs.getInt(1), new GregorianCalendar(Integer.parseInt(string[0]),Integer.parseInt(string [1]),Integer.parseInt(string [2])), rs.getFloat(3)
